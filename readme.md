...
| :--- | :--- | :--- | :---: |
| **[01. On-Premises Core Infrastructure](./01.\)WinServerOnPrem/)** | Systems & Core Routing | Dual Windows Server 2022 DCs, Active Directory Domain Services (AD DS), AD-Integrated DNS Replication, Cisco L3 Inter-VLAN Routing, DHCP Option 6 | 🟢 Completed |
| **[02. SD-WAN & Edge Redundancy](./02.\)FortinetSDWan/)** | Enterprise WAN / Security | Dual-WAN Failover (Primary Fiber + Cellular Backup), Performance SLA Probes, 802.3ad LACP, Fortinet FortiGate 40F | 🟢 Completed |
